...
`openspec/changes/<name>/findings/spec-test.md`, **each as an unticked checkbox** so
...
survived is the strongest finding you can write**, because it is a measurement rather
than a judgement.
